        ...
        if ($_SERVER['REQUEST_METHOD'] == "POST") {
            ...
            try {
                ...
                foreach ($rows as $r) {
                    $pase = isset($r[1]) ? $r[1] : '';
                    $pasen = isset($r[2]) ? $r[2] : '';
                    if ($db->setInvitados(mb_convert_encoding($r[0], 'UTF-8', 'ISO-8859-1'), $pase, $pasen) == false) {
                        $errors++;
                        continue;
                    }
                ...
                echo ('Se han insertado '.$inserted.' registros con éxito. <br/> <a href="'.env::site.'Home/invitados">Volver</a>');
